...
def get_all_on_readings(kanji_info):
    all_source_keys = ["davidluzgouveiaJlpt", "waniKani", "kanjiApi"]
    all_ = kanji_info.get("readings", {}).get("onyomi", {})
    return get_all_generic(all_, all_source_keys)
...
def get_order_index(kanji_info, order_data, NUMBER_DATA_NOT_FOUND_VAL):
    return order_data.get(kanji_info["kanji"], None) or NUMBER_DATA_NOT_FOUND_VAL
...
def get_ranks(kanji_info, NUMBER_DATA_NOT_FOUND_VAL, jiten_data=None, jpdb_data=None):
    ...
    def dig_scriptin(source_key, rank_type_key="charRank1224"):
    ...
    rank_aozora_doc = dig_scriptin("aozora", "docRank1224") or NUMBER_DATA_NOT_FOUND_VAL
    rank_wikipedia_char = dig_scriptin("wikipedia") or NUMBER_DATA_NOT_FOUND_VAL
    rank_wikipedia_doc = (
        dig_scriptin("wikipedia", "docRank1224") or NUMBER_DATA_NOT_FOUND_VAL
    )
    rank_online_news_char = dig_scriptin("news") or NUMBER_DATA_NOT_FOUND_VAL
    rank_online_news_doc = (
        dig_scriptin("news", "docRank1224") or NUMBER_DATA_NOT_FOUND_VAL
    )
    ...
    rank_drama_subtitles = (
        dig_1224("chriskempsonSubtitles") or NUMBER_DATA_NOT_FOUND_VAL
    )
